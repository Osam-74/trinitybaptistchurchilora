              ...
              return (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 ${isToday ? "bg-primary text-white" : "bg-primary/10 text-primary"}`}>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        {isToday && (
                          <span className="bg-primary text-white text-xs font-medium px-2 py-0.5 rounded-full">Today</span>
                        )}
                      </div>
                    ...
                    <a
                      href="#"
                      className="flex-shrink-0 text-sm text-primary font-medium hover:underline flex items-center gap-1"
                    >
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-sm border border-stone-200 p-8 animate-fade-in">
            ...
            {!subscribed ? (
              <form onSubmit={handleSubscribe} className="max-w-md mx-auto flex gap-3">
                ...
                <button
                  type="submit"
                  className="btn-shine px-6 py-3 bg-primary text-white font-medium rounded-xl hover:bg-primary-light transition-colors text-sm"
                >
                  Subscribe
                </button>
              </form>
