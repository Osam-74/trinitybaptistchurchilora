...
export default function AdminPostsPage() {
  ...
  const openEdit = (post: Post) => {
    setEditingPost(post);
    setForm({ title: post.title, body: post.body, scripture: post.scripture, mediaType: "text", mediaUrl: "", pinned: post.pinned, status: post.status });
    setShowForm(true);
  };
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-text-muted text-sm mt-1">Manage inspiring faith articles and weekly devotionals</p>
            </div>
