      ...
      <div className="max-w-2xl">
        <div className="bg-white rounded-2xl shadow-sm border border-stone-200 p-8">
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-primary mb-1">Pastor's Weekly Word</label>
              <textarea value={settings.pastorWord || ""} onChange={(e) => setSettings({ ...settings, pastorWord: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-stone-200 focus:outline-none focus:ring-2 focus:ring-accent/30 min-h-[100px]" placeholder="Walk faithfully with God today, and trust Him with your tomorrow." />
            </div>
