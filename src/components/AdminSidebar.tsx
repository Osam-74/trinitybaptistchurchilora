...
const navigationGroups: { group: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { href: "/sanctuary-g8/analytics", label: "Analytics", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
    ]
  },
  {
    group: "CONTENT",
    items: [
      ...
      { href: "/sanctuary-g8/news", label: "News & Events", icon: "M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 12h6m-6 4h2" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/sanctuary-g8/comments", label: "Comments", icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" },
    ]
  },
  {
    group: "EVENTS",
  ...
  },
  {
    group: "SYSTEM",
    items: [
      { href: "/sanctuary-g8/declarations", label: "Daily Declaration", icon: "M11 5.088v8.868a1 1 0 01-.589.913l-6.5 3.25A1 1 0 012.5 17.18V5.088A2 2 0 014.282 3.37l5.5-1.375A1 1 0 0111 3.088zM11 5.088L16 4c.55 0 1 .45 1 1v9.5c0 .55-.45 1-1 1h-5", permission: "manage_declarations" },
      { href: "/sanctuary-g8/activity-log", label: "Activity Log", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4", permission: "view_activity_log" },
  ...
  },
  {
    group: "ACCOUNT",
    items: [
      { href: "/sanctuary-g8/account", label: "My Account", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
    ]
  },
  {
    group: "VIEW SITE",
    items: [
      { href: "/", label: "View Site", icon: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" },
    ]
  }
];
