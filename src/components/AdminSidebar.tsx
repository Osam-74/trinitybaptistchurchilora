...
const navigationGroups: { group: string; items: NavItem[] }[] = [
  ...
  },
  {
    group: "SYSTEM",
    items: [
      { href: "/sanctuary-g8/declarations", label: "Daily Declaration", icon: "M11 5.088v8.868a1 1 0 01-.589.913l-6.5 3.25A1 1 0 012.5 17.18V5.088A2 2 0 014.282 3.37l5.5-1.375A1 1 0 0111 3.088zM11 5.088L16 4c.55 0 1 .45 1 1v9.5c0 .55-.45 1-1 1h-5" },
